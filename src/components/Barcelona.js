...
const Barcelona = ({ content }) => {
  ...
  return (
    <div className='country-page'>
      ...
      <EightImagesGallery
        landscapeUrls={images.slice(5, 9)}
        portraitUrls={images.slice(9, 13)}
      />
      {/* daytrip */}
      <Introduction url={images[9]} titleSize={"small"} title={"Costa Brava"} />
      <BlockQuote quote={quote} />
      <Spacer size={"sm"} />
      <ImageWithText
        title={"Day Trip"}
        text={parseText(daytrip)}
        image={images[3]}
      />
